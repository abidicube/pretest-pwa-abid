...
export const frontendConfig = (pwaConfig) => {
    if (pwaConfig) {
        ...
        return `
            :root {
                ...
                --font-pwa-default_font: ${(default_font && default_font !== '0') || 'proxima-nova'};
                --font-pwa-heading_font: ${(heading_font && heading_font !== '0') || 'proxima-nova'};
    ...
    return `
        :root {
            ...
            --font-pwa-default_font: proxima-nova;
            --font-pwa-heading_font: proxima-nova;
