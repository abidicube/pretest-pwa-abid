...
const font = localFont({
    src: [
        ...
        {
            path: '../../../../public/assets/fonts/proxima-nova-medium.woff2',
            weight: '500',
        },
        {
            path: '../../../../public/assets/fonts/proxima-nova-semibold.woff2',
            weight: '600',
        },
        {
    ...
    variable: '--font-proxima-nova', // set the font css variable name, which we refer in tailwind.config.js
});
